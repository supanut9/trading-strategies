...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SIGNALRESPONSE']._serialized_end=249
  _globals['_STRATEGYSERVICE']._serialized_start=251
  _globals['_STRATEGYSERVICE']._serialized_end=330
